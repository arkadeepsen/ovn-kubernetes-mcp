...
func (s *MCPServer) Show(ctx context.Context, req *mcp.CallToolRequest,
	...
	lines, err := s.k8sMcpServer.RunCommand(ctx, req, in.NamespacedNameParams, []string{cmd, "show"})
	if err != nil {
...
func (s *MCPServer) Get(ctx context.Context, req *mcp.CallToolRequest,
	...
	lines, err := in.PatternParams.ExecuteWithMatch(func() ([]string, error) {
		return s.k8sMcpServer.RunCommand(ctx, req, in.NamespacedNameParams, cmdArgs)
	}, in.Record == "")
	if err != nil {
		if in.Record != "" {
