...
func (s *MCPServer) ListBridges(ctx context.Context, req *mcp.CallToolRequest,
	...
	bridgeNames, err := s.k8sMcpServer.RunCommand(ctx, req, in, []string{"ovs-vsctl", "list-br"})
	if err != nil {
...
func (s *MCPServer) Show(ctx context.Context, req *mcp.CallToolRequest,
	...
	lines, err := s.k8sMcpServer.RunCommand(ctx, req, in.NamespacedNameParams, []string{"ovs-vsctl", "show"})
	if err != nil {
...
func (s *MCPServer) ListPorts(ctx context.Context, req *mcp.CallToolRequest,
	...
	ports, err := s.k8sMcpServer.RunCommand(ctx, req, in.NamespacedNameParams, []string{"ovs-vsctl", "list-ports", in.Bridge})
	if err != nil {
...
func (s *MCPServer) ListInterfaces(ctx context.Context, req *mcp.CallToolRequest,
	...
	ports, err := s.k8sMcpServer.RunCommand(ctx, req, in.NamespacedNameParams, []string{"ovs-vsctl", "list-ifaces", in.Bridge})
	if err != nil {
